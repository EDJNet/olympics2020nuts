...
all_medalists_df$medalist_link[all_medalists_df$medalist_link == "/wiki/Gianmarco_Tamberi"&all_medalists_df$delegation_link=="/wiki/Qatar_at_the_2020_Summer_Olympics"] <- "/wiki/Mutaz_Essa_Barshim"
...
all_medalists_df <- bind_rows(all_medalists_df,
                              double_medals)
