...
tibble::tibble(columns = colnames(all_medalists_wd_nuts_df),
               total = nrow(all_medalists_wd_nuts_df),
               total_missing = purrr::map_dbl(.x = all_medalists_wd_nuts_df,
...
all_medalists_wd_nuts_df %>% 
  readr::write_csv(file = "all_medalists_wd_nuts.csv")
```


You can download the data [from the repository](https://github.com/EDJNet/olympics2020nuts) including this script, or directly [clicking on this link](all_medalists_wd_nuts.csv).
